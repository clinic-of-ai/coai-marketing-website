...
export default {
    ...
    processes: [
      {
        ...
        heading:
          "Let's analyze your workflow and identify optimization opportunities.",
        paragraph:
      ...
      },
      {
        ...
        heading:
          "We'll create a prioritized improvement roadmap tailored to your needs.",
        paragraph:
      ...
      },
      {
        ...
        heading:
          "We'll deploy AI solutions strategically to transform your operations.",
        paragraph:
      ...
      },
      {
        ...
        heading:
          "We provide ongoing support and collaboration to ensure your success.",
        paragraph:
  ...
  clientBenefits: {
    ...
    paragraph:
      "This way you can ensure that your investment will boost your productivity, increase gains, save money, and reduce risk.",
    cta: {
      label: "Book a call",
      formId: config.bookings.discoveryCall.id,
      formUrl: config.bookings.discoveryCall.url,
    ...
    cards: {
      ...
      card2: {
        ...
        description:
          "We design and implement cutting-edge solutions using the latest technologies, ensuring seamless integration into your company's workflow for maximum adaptability and impact.",
      },
      card3: {
        title: "Seamless Integration",
        description:
          "We are ensuring seamless integration into your company's workflow for maximum adaptability and impact.",
      },
      card4: {
  ...
  quote: {
    quote:
      "As soon as we uncover the full extent of your workflow, we aim to eliminate all bottlenecks holding you back and work towards building a comprehensive system that can incrementally enhance your value chain from start to finish.",
  ...
  industries: {
    ...
    paragraph:
      "We are your partner for AI research and development, regardless of your size, expertise, or financial constraints. We will help you succeed and always stay one step ahead of the curve.",
    industries: [
      {
        heading: "retail & services",
        paragraph:
          "Our cutting-edge AI solutions are tailored to address the specific challenges and objectives of the retail and services sector, enabling you to upgrade your operations and deliver unparalleled customer experiences.",
        image: {
  ...
  insights: {
    title: "Expert advice",
    heading:
      "Discover tools and insights to help you navigate the AI landscape.",
    bloglink: "https://blog.clinicofai.com",
    articles: [
      {
        heading:
          "Critical Thinking and Polymathy: The Epistemic Pillars of Innovation",
        description:
          "In the rapidly evolving landscape of today, the convergence of critical thinking and polymathy emerges as pivotal for fostering innovative solutions.",
        link: "https://blog.clinicofai.com/critical-thinking-and-polymathy-the-epistemic-pillars-of-innovation/",
        thumbnail:
          "https://storage.googleapis.com/msgsndr/SRTw3xlSbwAV7iycIh1t/media/6790d9cd2aa71a6996681cdc.webp",
      },
      {
      ...
      {
        heading:
          "Repurposing AI-Generated Content: Strategies for Effective Digital Marketing",
        description:
          "In the field of digital marketing, the rapid advancement of artificial intelligence (AI) technologies has created unprecedented opportunities for streamlined content creation and distribution.",
        link: "https://blog.clinicofai.com/repurposing-ai-generated-content-strategies-for-effective-digital-marketing/",
        thumbnail:
          "https://storage.googleapis.com/msgsndr/SRTw3xlSbwAV7iycIh1t/media/6790d9cde54e4a190b443eea.jpeg",
      },
      {
      ...
      {
        heading:
          "The AI Revolution: Empowering SMEs and Addressing the Paradigm Shift",
        description:
          "The importance of the new Meta Area of study and its education.",
        link: "https://blog.clinicofai.com/the-ai-revolution-empowering-smes-and-addressing-the-paradigm-shift/",
        thumbnail:
          "https://storage.googleapis.com/msgsndr/SRTw3xlSbwAV7iycIh1t/media/6790d9cd62c4de7a0e112575.webp",
      },
      {
        heading:
          "Revolutionizing Sales: How AI is Changing the Way Technology Vendors Approach the Market",
        description:
