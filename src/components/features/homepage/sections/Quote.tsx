...
export function Quote({ content }: QuoteSectionProps) {
  return (
    <section className="bg-background pb-20 pt-10 font-sans md:px-6 lg:pb-[120px] lg:pt-20">
      <div className="container mx-auto w-full rounded-lg bg-[#233171] p-4 text-white">
        <div className="flex w-full flex-col-reverse gap-8 lg:flex-row">
          <figure className="relative h-[380px] w-full rounded-lg bg-gray-200 lg:h-[460px] lg:w-[460px]">
            <div className="absolute left-4 top-4 z-10 rounded-full bg-[#F69000] px-[16px] py-[8px]">
          ...
          <article className="flex h-auto w-full flex-1 flex-col justify-between gap-y-20 pt-6 lg:gap-y-0 lg:p-6">
            ...
            <footer className="flex items-end gap-x-10">
              <div className="space-y-2 font-sans text-base">
                ...
                <p className="text-white/40">{content.jobTitle}</p>
              </div>

              <hr className="h-full w-[2px] bg-slate-400" />
              ...
              <div className="relative">
                ...
                <Button
                  className="rounded-full border-[3px] border-white bg-[#25D366] py-8 transition-colors hover:bg-[#1da850]"
                  onClick={() =>
                    window.open("https://wa.link/g7avv0", "_blank")
                  }
                >
                  <svg
