...
export function IntroTitle(props: IntroTitleProps) {
  const { heading, title, align, size, className } = props;
  return (
    <div className={cn(introTitleVariants({ align, size }), className)}>
      <h2 className="font-mono text-base font-semibold uppercase opacity-40">
        {heading}
      </h2>
